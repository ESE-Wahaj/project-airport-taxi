                    ...
                    <div className="mb-8">
                        ...
                        <div className="md:flex justify-center md:gap-20  mt-8">
                            {/* <Link to="/forget-password"> */}
                                <button type="button" className="bg-black text-[#FEB601] md:text-xl p-2 rounded flex w-[30vh] mb-4 md:w-[350px] max-w-md items-center justify-center mr-4" onClick={handleNavigate}>
                                    Forget Password
