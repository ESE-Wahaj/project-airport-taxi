...
type AiportTaxiAPI interface {
	...
	GetCarByIdAPI(c *gin.Context,  carID models.DeleteCarRequest) (*models.Car, error)
	UpdateCarAPI(c *gin.Context, updatecar models.UpdateCarRequest) error
	DeleteCarAPI(c *gin.Context,  carID models.DeleteCarRequest) error
	...
	UpdateBookingStatusAPI(c *gin.Context, req *models.UpdateBookingStatus) error
}
