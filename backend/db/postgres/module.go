...
type AiportTaxiDB interface {
	...
	GetCarByIdDB(carID models.DeleteCarRequest) (*models.Car, error)
	...
	CarExistsDb(cardId models.DeleteCarRequest) (bool, error)
	DeleteCarDb(carID models.DeleteCarRequest) error
	...
	UpdateBookingStatusDb(req *models.UpdateBookingStatus) error
}
